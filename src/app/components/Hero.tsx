...
const Hero = () => {
  return (
<div className="w-full h-screen bg-[url('/picture/glob.jpg')] bg-center bg-cover bg-no-repeat">
  {/* Nav */}
  ...
  <div className="absolute bg-black/20 py-2 md:top-[75%] sm:top-[70%] xs:top-[60%]">
