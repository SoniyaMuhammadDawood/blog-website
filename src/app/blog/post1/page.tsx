...
>
  ...
  <div className="mt-12 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
    <div className="">
      <a href="#" className="text-gray-900 font-serif font-bold italic tracking-wide text-3xl mb-2">
      ...
      <blockquote className="border-l-4 text-lg  leading-8 my-5 p-5 text-indigo-600">
